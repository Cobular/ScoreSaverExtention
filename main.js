...
let key = JSON.parse(getKey(`https://beatsaver.com/api/maps/by-hash/${song_hash}`)).key
...
$(function () {
    $(".column .is-one-quarter").append(`
        ...
        <div style="width: 64px">
            ...
            <a href="beatsaver://${key}" class="button tooltip saberSaverButton umami--click--download-button-${key}"><img src="https://bsaber.com/wp-content/themes/beastsaber-wp-theme/assets/svg/ico-cloud-download.svg">
